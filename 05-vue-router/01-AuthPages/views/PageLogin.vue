  ...
  <div class="page-auth">
    <ui-container>
      ...
      <form class="form" @submit.prevent="handleSubmit">
        ...
        <div class="form__append">Нет аккаунта? <router-link :to="{ name: 'register-form' }" class="link">Зарегистрируйтесь</router-link></div>
      </form>
    </ui-container>
  </div>
</template>
...
export default {
  ...
  methods: {
    handleSubmit() {
      const targetPath = this.$route.query.from ?? '/';
